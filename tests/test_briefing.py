...
from app.graphs.writers.briefing import (
    aggregate_precedents_pure, generate_briefing, verify_briefing_pure,
)
from app.schemas.writers import BriefingDoc

PRECEDENTS = [
    {"expense_summary": "[식비] 회식 — 45,000원", "decision": "escalate",
     "decided_by": "AGENT", "is_override": False, "reason": None},
    {"expense_summary": "[식비] 회식 — 45,000원", "decision": "reject",
     "decided_by": "ADMIN", "is_override": True, "reason": "한도 초과"},
    {"expense_summary": "[도서] 교재 — 32,000원", "decision": "approve",
     "decided_by": "AGENT", "is_override": False, "reason": None},
]
