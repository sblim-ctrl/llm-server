...
_LEGACY_CATEGORY_ALIASES: dict[str, str] = {
    ...
    "행사": "행사_활동",
    "디자인": "기타",
    # 언더바 누락 방어 — 처음엔 마이그레이션 공지가 실제로 언더바를 빠뜨렸다고
    # 봤으나, 2026-08-10 백엔드 회신으로 표시 오류(마크다운이 언더바를 삼킴)였을
    # 뿐 실행값은 "행사_활동"(언더바 포함)이 맞다고 확인됨 — docs/claude_session_
    # handoff.md 참고. 위험은 사라졌지만 무해해서 그대로 둔다.
    "행사활동": "행사_활동",
}
