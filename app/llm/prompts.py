...
DEFAULT_VERSIONS = {
    ...
    "classifier": "v4",      # 전역 9종 카테고리 대응(v3) + 물건 형태의 교육 지출
                             #  오분류 수정(v4). 실모드 A/B 승격(2026-08-04, 2회 재현):
                             #  v3 11/14(78.6%) → v4 13/14(92.9%), 회귀 0건.
                             #  개선 2건 모두 교육 — "스터디 교재 구입"이 비품으로,
                             #  "전공 서적 3권"이 기타로 가던 것. v3 few_shot의 교육
                             #  예시가 '온라인 강의 구독' 하나뿐이라 물건 형태의 교육
                             #  지출을 배울 수 없었다. 하니스 scripts/ab_classifier.py.
